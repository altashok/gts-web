...
export const enrollTranslations = {
  ta: {
    ...
    'enroll.form.level': 'தற்போதைய நிலை',
    'enroll.form.skill': 'தேவைப்படும் வகுப்பு',
    'enroll.form.skill.placeholder': 'வகுப்பைத் தேர்ந்தெடுக்கவும்',
    'enroll.form.skill.options': ['தமிழ்', 'பரதநாட்டியம்', 'சங்கீதம்', 'வீரக்கலைகள்', 'வரைகலை', 'சதுரங்கம்', 'இலவச கோடை வகுப்புகள்', 'வேறு ஏதாவது'],
    'enroll.form.level.beginner': 'ஆரம்ப நிலை',
    'enroll.form.level.intermediate': 'இடைநிலை',
    'enroll.form.level.advanced': 'உயர் நிலை',
  ...
  en: {
    ...
    'enroll.requirements.point2': 'Basic understanding of English or Tamil',
    'enroll.requirements.point3': 'Parent/guardian support for younger children',
    'enroll.requirements.point4': 'Regular attendance and participation in classes',
    ...
    'enroll.form.skill.options': ['Tamil', 'Barathanatyam', 'Vocal', 'Martial Arts', 'Drawing', 'Chess', 'Free Summer Classes', 'Something else'],
