      ...
      <section className="bg-primary py-8 mb-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <ScrollReveal animation="fade-in">
            ...
            <p className="text-[21px] md:text-base text-primary-foreground/80 max-w-2xl mx-auto font-medium">{t('United Kingdom')}</p>
          </ScrollReveal>
        </div>
      </section>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Image src="/posters/free-summer-classes-uk-2026.png" alt="Tamil Roadmap" width={612} height={100} className="mx-auto mb-8" />      
      </div>
